...
:uri-plugin: https://github.com/danyill/oscd-import-ieds
:uri-ci-bundle: https://danyill.github.io/oscd-import-ieds/oscd-import-ieds.js
:uri-material-icons: https://fonts.google.com/icons
:uri-openscd-core-plugin-demo: https://danyill.github.io/oscd-import-ieds/index.deploy.html
...
// badges
image:https://github.com/danyill/oscd-import-ieds/actions/workflows/test.yml/badge.svg[title='Build Status']
...
For a local resource, begins without a forward slash, e.g. `plugins/oscd-import-ieds/dist/oscd-import-ieds.js`. 
